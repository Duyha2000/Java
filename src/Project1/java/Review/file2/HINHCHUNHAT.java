package Project1.java.Review.file2;
...
public class HINHCHUNHAT {
    public static void main(String[] args) {
        File inputFile = new File("src/Project1.java.Review.file2/chieudai&rong");
        File result = new File("src/Project1.java.Review.file2/result");
        try (
